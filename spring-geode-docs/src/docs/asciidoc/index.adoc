...
and SDGfootnote:[SDG]support for both {spring-data-geode-docs-html}/#apis:transaction-management[Local Cache]
...
(SDGfootnote:[SDG, Spring Data for Apache Geode and Spring Data for Pivotal GemFire are commonly known as SDG.])
